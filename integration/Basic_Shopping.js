describe('Sceanario - Items ordered within the existing stock range', () => {
    ...
    it('Searches a specifc cricket shirt ,selects it & chose number of items', function () {
        ...
        //const sizegroup1="14 years";
        //const sizegroup2="Chest 26";
        ...
        //cy.get('[placeholder="Search product or brand"]').type(searchitem1).type('{enter}')
        ...
        if (orderquantity>50)
        {   //when executed with any quantity which is greater than stock quantity , anyways the 
